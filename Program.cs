...
{
    case "add":
        Console.WriteLine($"Addition: {num1} + {num2} = {BasicCalculator.Arithmetic.add(num1, num2)}");
        break;
    case "subtract":
        Console.WriteLine($"Subtraction: {num1} - {num2} = {BasicCalculator.Arithmetic.subtract(num1, num2)}");
        break;
    case "multiply":
        Console.WriteLine($"Multiplication: {num1} * {num2} = {BasicCalculator.Arithmetic.multiply(num1, num2)}");
        break;
    case "divide":
        if (num1 % num2 == 0)
        {
            Console.WriteLine($"Division: {num1} / {num2} = {BasicCalculator.Arithmetic.divide(num1, num2)}");
        }
        else
